                    ...
                    <dl className="mt-8 space-y-6">
                      ...
                      <dd className="flex text-base text-teal-50">
                        <PhoneIcon
                          ...
                          aria-hidden="true"
                        />
                        <span className="ml-3">+995 599 00 00 00</span>
                      </dd>
                      <dt>
                        <span className="sr-only">ელ ფოსტა</span>
                      </dt>
                      <dd className="flex text-base text-teal-50">
                        <MailIcon
                          className="flex-shrink-0 w-6 h-6 text-teal-200"
                  ...
                  <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                    ...
                    >
                      ...
                      <div className="sm:col-span-2 sm:flex sm:justify-end">
                        <button
                          type="submit"
                          className="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 sm:w-auto"
                        >
                          გაგზავნა
                        </button>
                      </div>
